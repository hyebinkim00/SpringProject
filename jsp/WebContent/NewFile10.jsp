...
function jdbctest(){
		...
		let s=document.getElementById("example1").value;
...
<h2>중고차 장기 렌트</h2>
 ...
 <input type="submit" class="btn btn-primary col-sm-1" value="검색">
  ...
  <br><br>
    ...
    <div class="form-check-inline">
      <input type="checkbox" value="휘발유" id="example1"  name="example1" onclick="jdbctest()"><strong>&nbsp;휘발유&nbsp;</strong>
